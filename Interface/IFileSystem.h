...
public:
	bool FileExists(const char *pFileName, const char *pPathID) { return false; }
	...
	bool IsDirectory(const char *pFileName, const char *pathID){ return false; }
	bool GetFileTypeForFullPath(char const *pFullPath, wchar_t *buf, size_t bufSizeInBytes){ return false; }
};
