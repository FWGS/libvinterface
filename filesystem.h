...
public:
	...
	const char *RelativePathToFullPath( const char *pFileName, const char *pPathID, char *pLocalPath, int localPathBufferSize, PathTypeFilter_t pathFilter = FILTER_NONE, PathTypeQuery_t *pPathType = 0);
...
#define FILESYSTEM_MODULE_NAME "filesystem_stdio." OS_LIB_EXT
